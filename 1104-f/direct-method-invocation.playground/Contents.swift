...
//1.
class Person {
    var name: String = "Nikolas"
    
    func printName() {
        print("My name is \(name)")
    }
    
    func helloPerson(helloPerson: Person) {
        print("Hello \(helloPerson.name)!")
    }
}
...
person2.printName()
person.helloPerson(helloPerson: person2)
person.printName()
person2.helloPerson(helloPerson: person)